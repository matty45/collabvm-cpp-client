...
namespace cvm::ws
{
        ...
        signals:
            void signal_remove_user_received(const QString& username, const QUrl& server);
            void signal_add_user_received(const QString& username, const user::rank& rank, const QUrl& server);
